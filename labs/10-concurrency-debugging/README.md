...
本实验配套 Lesson 10，用统一的最小事件处理模型练习：context 取消、错误处理、状态记录、并发安全、benchmark 和生产 checklist。

## 关键词

race detector, goroutine dump, block profile, mutex profile, deadlock, leak
