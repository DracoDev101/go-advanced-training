...
func SampleEvents() []Event {
    return []Event{
        {ID:"job-1", Kind:"concurrency-debugging", Attempts:1},
        {ID:"job-2", Kind:"concurrency-debugging", Attempts:2},
    }
}

func Topic() string { return "Lesson 10: 并发 Debugging 与 Race Detector" }
